...
constexpr auto qt_meta_stringdata_CLASSLoginWindowENDCLASS = QtMocHelpers::stringData(
    ...
    "handleUserAuthenticationFailed"
);
...
Q_CONSTINIT const QMetaObject LoginWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoginWindowENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'handleUserAuthenticated'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const UserInfo &, std::false_type>,
        // method 'handleUserAuthenticationFailed'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->loggedInSuccessfully((*reinterpret_cast< std::add_pointer_t<UserInfo>>(_a[1]))); break;
        case 1: _t->closed(); break;
        case 2: _t->on_LoginPushButton_clicked(); break;
        case 3: _t->handleUserAuthenticated((*reinterpret_cast< std::add_pointer_t<UserInfo>>(_a[1]))); break;
        case 4: _t->handleUserAuthenticationFailed(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LoginWindow::*)(const UserInfo );
            if (_t _q_method = &LoginWindow::loggedInSuccessfully; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &LoginWindow::closed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LoginWindow::loggedInSuccessfully(const UserInfo _t1)
{
